...
export default {
  ...
  methods: {
    findCity() {
      return new Promise((resolve, reject) => {
        jsonhttp
          // .get("/ISAPI/Streaming/channels/102/httppreview")
          .get("http://192.168.0.67/ISAPI/Streaming/channels/102/httppreview")
          // .get("http://admin:zab88888@192.168.0.67/ISAPI/Streaming/channels/102/httppreview")
          .then(resolve)
          .catch(reject);
      });
    },
    getImg() {
      // return "http://admin:zab88888@192.168.0.67/ISAPI/Streaming/channels/102/httppreview"
      this.findCity().then(res=>{
        console.log(res,'res');
      }).catch(err=>{
        console.log(err,'err');
      })
  ...
  mounted() {
    ...
    //   let image = new Image();
    //   image.src = require("@/assets/img/v"+indexs+".png");
    //   this.image = image;
